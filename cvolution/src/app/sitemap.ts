...
export default function sitemap(): MetadataRoute.Sitemap {
  const routes = [
    ...
    { path: "/motivationsschreiben-beispiel", priority: 0.8, changeFrequency: "monthly" as const },
    { path: "/motivationsschreiben-tipps", priority: 0.8, changeFrequency: "monthly" as const },
    { path: "/motivationsschreiben-praktikum", priority: 0.8, changeFrequency: "monthly" as const },
    { path: "/motivationsschreiben-ohne-erfahrung", priority: 0.8, changeFrequency: "monthly" as const },
    ...
    { path: "/bewerbungsunterlagen-check", priority: 0.8, changeFrequency: "monthly" as const },
