        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-12 grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-3">
            {SERVICE_OFFERS.filter((product) => !product.isPremium).map((product) => (
              <article
                key={product.name}
                className="group relative flex min-h-[20rem] flex-col overflow-hidden rounded-3xl bg-white p-6 ring-1 ring-[#dce5ef] shadow-[0_1.25rem_3.5rem_rgba(15,37,65,0.07)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_1.75rem_4.5rem_rgba(15,37,65,0.12)] focus-within:ring-2 focus-within:ring-[#204878]"
              >
